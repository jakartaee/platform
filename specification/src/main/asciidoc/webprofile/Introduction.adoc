...
any remote functionality, the _Jakarta Enterprise Beans_ annotation may not be used to inject
...
under the Java Community Specification Process as JSR-316. The spec leads for the
...
under the Java Community Specification Process as JSR-342. The Expert Group work for
...
under the Java Community Specification Process as JSR-366. The Expert Group work for
this specification was conducted by means of the
