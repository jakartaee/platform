...
specification mandates support for Java(TM) Platform, Standard Edition 21 API.  Because of this, all Core Profile 12.0 APIs must support the Java(TM) Platform, Standard Edition 21 API.
