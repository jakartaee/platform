...
This chapter defines the contents of the Jakarta™ EE 12.0 Core Profile.
...
* Jakarta Contexts and Dependency Injection (CDI) 5.0 (CDI Lite section)*
...
The Java SE section of the CDI 5.0 specification is not required for Core Profile implementations. Only Full CDI implementations are required to support the (CDI) Java SE API classes.
