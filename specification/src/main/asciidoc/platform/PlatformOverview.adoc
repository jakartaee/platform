...
The Jakarta XML Web Services, Jakarta XML Web Services, XML Binding and SOAP with Attachments have been removed
from the Platform as of Jakarta EE 11. See <<a2333, Removed Jakarta Technologies>>.
