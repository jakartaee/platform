...
technologies work together to provide support for web services. JAX-WS
and Jakarta XML-based RPC
...
web services and is a follow-on to Jakarta XML-based RPC. JAX-WS offers extensive web
services functionality, with support for multiple bindings/protocols.
JAX-WS and Jakarta XML-based RPC are fully interoperable when using the SOAP 1.1 over
...
7. See <<a2331, Pruned Java Technologies>>”.
...
<<a2331, Pruned Jakarta Technologies>>.”
...
image::JavaEEinteroperability.png[]
...
Reference the <<a4422, "Specification Comparison">> and <<relateddocs, “Related Documents">> appendices for more information.
