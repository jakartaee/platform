...
environment<<a3651, 4>>. The containers for these application
...
Injection>>”, and the use of interceptors<<a3652, 5>>. The
...
|CDI<<a3656, 9>>
|CDI-style managed beans<<a3657, 10>>
...
is provisioned for use by the application<<a3660, 13>>.
