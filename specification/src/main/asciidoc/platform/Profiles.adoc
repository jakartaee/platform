...
new profile, or to revise an existing one, will be submitted as a Jakarta EE
Specification Process. Once the Jakarta EE Specification Process is approved, 
an expert group will be formed and conduct work as dictated by the process. The Jakarta EE
