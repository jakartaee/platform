...
For example, in
_link:#a475[See Servlets/Server Pages Accessing Enterprise Beans]_ , the call
...
image:../images/Platform_Spec-8.png[image]
...
_link:#a475[See Servlets/Server Pages Accessing Enterprise Beans]_ access
...
clientlink:#a3650[3]. Returning from the _service_ or _doFilter_ method to the
...
As specified above in link:#a493[See Transaction Non-Requirements],” requests
...
no deployment hint is provided. link:#a3399[See Jakarta EE Application Client
