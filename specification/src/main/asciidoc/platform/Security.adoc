...
requirements for the Jakarta™ Platform, Enterprise Edition (Jakarta EE) that
...
consists of methods of the Jakarta EE Security API _SecurityContext_
interface, and methods of the EJB _EJBContext_ interface and the servlet
_HttpServletRequest_ interface. The methods of the Jakarta EE Security API
...
mapping of security roles to user groups as defined by the Jakarta EE
...
In a Jakarta EE product that contains an EJB
...
Jakarta EE Security API specification.
