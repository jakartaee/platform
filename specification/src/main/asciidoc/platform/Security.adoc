...
_<<a265, Fulfilling the
Original Request>>_ .

[[a265]]
.Fulfilling the Original Request
image::Platform_Spec-6.png[]
...
associated with the user.<<a3648, 1>>
